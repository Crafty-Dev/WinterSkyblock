...
public class NetherChunkGenerator extends NoiseBasedChunkGenerator {
    ...
    public static final Codec<NoiseBasedChunkGenerator> CODEC = RecordCodecBuilder.create((p_224323_) -> {
        ...
        }))).apply(p_224323_, p_224323_.stable(NetherChunkGenerator::new));
    });

    public NetherChunkGenerator(Registry<StructureSet> structureSets, Registry<NormalNoise.NoiseParameters> noiseParameters, BiomeSource biomeSource, Holder<NoiseGeneratorSettings> settingsHolder) {
